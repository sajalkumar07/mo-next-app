...
import SlidingPagination from "../../Homepage/slidingPagination"; // Import the reusable component
...
const AllReviews = () => {
  ...
  return (
    <div className="flex justify-center flex-col items-center w-full">
      {/* Desktop Section */}
      <div className="w-full desktop-only relative px-8">
        <div className="label d-flex">
          <p className="varienttxt mt-3 ml-4">
        ...
        <div className="flex overflow-x-auto scroll-smooth no-scrollbar gap-4 py-4">
          {reviews.map((review, index) => (
            <div
              key={index}
              className="flex flex-col bg-white border shadow-md shadow-black/30 py-4 px-4 flex-shrink-0 space-y-4 h-auto w-[309px] overflow-hidden"
            >
      ...
      <div className="w-full mobile-only">
        <div className="label d-flex">
          <p className="varienttxt mt-3 ml-4">
            <span className="text-wrapper">OWNER'S</span>
            <span className="span">&nbsp;</span>
            <span className="text-wrapper-2">REVIEW</span>
          </p>
        </div>
