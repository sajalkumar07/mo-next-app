...
const ProsConsVarients = React.forwardRef(({}, ref) => {
  ...
  const pros = singlecardData?.data?.product_id?.pro;
  const cons = singlecardData?.data?.product_id?.cons;
...
export default ProsConsVarients;
